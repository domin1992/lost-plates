@if ($marker['formatted_address'])
    <a href="{{ $marker['google_maps_link'] }}" class="flex items-center w-full mb-2 hover:text-purple-heart focus:text-purple-heart transition-colors group" target="_blank" rel="nofollow">
