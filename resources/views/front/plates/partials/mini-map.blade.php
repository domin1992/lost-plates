<a href="{{ $marker['google_maps_link'] }}" class="flex items-center w-full mt-1 hover:text-purple-heart focus:text-purple-heart transition-colors group" target="_blank" rel="nofollow">
