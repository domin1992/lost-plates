<template>
    <div :class="['bg-white absolute bottom-0 left-0 right-0 mx-auto rounded transition-all p-4 flex flex-col z-10', activeMarker ? 'translate-y-0 block' : 'translate-y-full hidden', detailsExpanded ? 'h-[calc((100vh-3.5rem)/2)] w-full' : 'h-48 w-5/6']" ref="details">
